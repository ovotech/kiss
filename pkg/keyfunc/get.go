...
var (
	...
	// defaultRefreshTimeout is the default duration for the context used to create the HTTP request
	// for a refresh of
	// the JWKs.
...
// backgroundRefresh is meant to be a separate goroutine that will update the keys in a JWKs over a
// given interval of
// time.
